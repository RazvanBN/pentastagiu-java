...
public class Monster extends Characters implements Attacking{

    private static final int attackDamage = 15;
    private static final int attackEnergyUse = 3;

    public Monster(String name, int healthPoints, int energyPoints, int locationX, int locationY) {
